...
class ChangeMemberRole {
    ...
    ChangeMemberRole(MembershipRepository memberships, UserDirectory users, Owners owners, AuditTrail audit) {
    ...
    @Transactional
    MemberView change(UUID userId, Membership.Role role) {
