...
public class AccessTokenIssuer {
    ...
    AccessTokenIssuer(JwtEncoder encoder, @Value("${app.security.issuer}") String issuer) {
        this.encoder = encoder;
        this.issuer = issuer;
    }

    String issue(AppUser user, UUID activeOrganizationId) {
    ...
    static long accessTokenSeconds() {
